"""
Django settings for fullstacksafari project.
...
ALLOWED_HOSTS = []
# ALLOWED_HOSTS = [] This is not applied when the debug mode is on
...
INSTALLED_APPS = [
    ...
    'django.contrib.contenttypes', #Framework which provides high level, generic interface for working with models
    'django.contrib.sessions',     #Session Framework
    'django.contrib.messages',     #Messaging Framework
    'django.contrib.staticfiles',  #Framework for managing static files like css and js
    'applove.apps.ApploveConfig',
]
# Middleware is Django stuff that sits between the browser request and the view's response
MIDDLEWARE = [
...
ROOT_URLCONF = 'fullstacksafari.urls' #Indicates the python module where the root urls of your application are defined
...
WSGI_APPLICATION = 'fullstacksafari.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'static'),  # Linda added this. It's critically important but I don't understand it yet.
)
